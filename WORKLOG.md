...
- 결정 & 이유(why) — 상세 근거는 [ADR-0010](./docs/adr/0010-scheduled-public-data-sync.md)에 전부 기록, 요지만:
...
- 관련: 브랜치 `feat/scheduled-sync-p3`, ADR-0010, TS-019, CLAUDE.md 로드맵 P3(마지막 조각 완료), ADR-0002(멱등)·ADR-0006(soft-delete diff·오픈API 다운로드 경로).
