...
- **다음 세션 = 후속 백로그 F1~F6** — A8 나머지 지역(쿼터)·Web Push 전송(실기기)·카카오모빌리티 도로 폴리라인(활용신청)·그늘/비 경로·HEAT_ESCAPE 알림·Fargate cpu → [`docs/BACKLOG.md`](./docs/BACKLOG.md)에 상세, `/geuneul-start`로 구동.
