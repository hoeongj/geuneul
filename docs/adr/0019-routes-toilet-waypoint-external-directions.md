...
- 상태: 승인(초기 MVP 구현, 2026-07-10). 도로 폴리라인은 ADR-0021, 그늘·비 corridor 오버레이는 ADR-0024, 그늘 경유 경로는 ADR-0027에서 후속 구현됐다.
...
- **초기 MVP의 한계:** 도로 폴리라인·그늘/비 경로는 당시 미구현이었다. 후속 구현과 현재 동작은 ADR-0021·ADR-0024·ADR-0027을 기준으로 한다.
