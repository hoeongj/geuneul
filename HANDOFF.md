...
- **미착수/후속 — 외부 승인 대기 블로커 0건(전부 해소).** (~~① 쉼터 전국(safetydata)~~ — **완료 PR #58/TS-027**, 전용키 계약검증·전국 60,297건 CSV 스냅샷 적재. · ~~② 상권정보 STUDY_CAFE/CAFE~~ — **완료 PR #56**, 승인 확인·계약검증·격자 적재. · ~~EventBridge~~ #42 · ~~ALB HTTPS~~ #43 · ~~화장실 재적재~~ +5,437 · ~~AI 유효키~~ #41.) **남은 것은 전부 additive 후속**(아래): 쉼터 air_conditioned 백필(CSV 경로 미지원)·safetydata IP 해제 시 직접 API 자동동기화·급증 SSE 프론트·커뮤니티 최소 UI 등.
