...
### TS-014 · 2026-07-09 — Boot 4 `@WebMvcTest`가 시큐리티 오토컨피그를 안 끌어옴: `SecurityConfig` Import만으론 `HttpSecurity` 빈이 없다
...
### TS-015 · 2026-07-09 — CI(실 Postgres)에서만 터진 500: 네이티브 쿼리 프로젝션에 `OffsetDateTime` 선언 → `Instant` 언프로젝션 실패
